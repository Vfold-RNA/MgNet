...
if use_cuda:
    print('set torch.backends.cudnn.benchmark = False', flush=True)
    torch.backends.cudnn.benchmark = False
    print('set torch.backends.cudnn.enabled = False', flush=True)
    ...
    print('Only using the first GPU device: 0', flush=True)
